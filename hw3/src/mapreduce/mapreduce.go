...
func MapName(fileName string, MapJob int) string {
	return "TEMP/mrtmp." + fileName + "-" + strconv.Itoa(MapJob)
}
...
func (mr *MapReduce) Merge() {
	...
	file, err := os.Create(FinalName(mr.file))
	if err != nil {
